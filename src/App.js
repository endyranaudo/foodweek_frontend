    ...
    return (
      <div>
        <Switch>
          ...
          <Route exact path="/search" render={props => {return(<RecipeSearch username={username} signout={signout} />)}}/>
          ...
          <Route exact path="/list" render={props => {return(<ShoppingList username={username} signout={signout} items={this.state.ingredients} handleClickAdd={this.handleClickAdd} />)}}/>
